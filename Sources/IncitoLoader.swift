...
public typealias IncitoLoader = FutureResult<IncitoDocument>
...
func decodeIncitoDocument(jsonData: Data) -> FutureResult<IncitoDocument> {
    return Future(work: {
        Result.init(catching: { try IncitoDocument(jsonData: jsonData) })
    })
}
